...
if(isset($_GET["search"])) {
	// 搜索
	require_once(View::getView('page-search'));
	exit;
}
?>
...
<div class="main-content index-page clearfix">
	<!-- 微语 -->
	<?php if(blog_tool_ishome() && $web_config['open_weiyu']):?>
    ...
    <div class="post-lists">
		...
		?>
			...
			<div style="margin-top: 20px;text-align: center;">
				<h1>Not Found</h1>
				<p>抱歉，本破站没有</p>
				<a href="/?search" title="有本事点我试试？"><img src="<?php echo TEMPLATE_URL?>images/404.jpg"></a><br/>
				<a href="/?search" title="点击去搜索看看"><button>搜索一下</button></a>
			</div>
